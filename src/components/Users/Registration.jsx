...
const Registration = () => {
    ...
    const onRegistration = async () => {
        ...
        if (IsEmail(email)) {
            ...
            let result = await RegistrationRequest(email, name, username, mobile, password, photo)
            if (result === true) {
                navigate("/login")
            }
        }
                        ...
                        <div className="card-body">
                            ...
                            <div className="row m-0 p-0">
                                    ...
                                    <div className="col-md-4 text-start p-2">
                                        ...
                                        <input ref={(input)=>NameRef=input} placeholder=" Name" className="form-control" type="text"/>
                                    </div>
                                    <div className="col-md-4 text-start p-2">
                                        <label>Last Name</label>
                                        <input ref={(input)=>userNameRef=input} placeholder="user Name" className="form-control" type="text"/>
                                    </div>
                                    <div className="col-md-4 text-start p-2">
                            ...
                            <div className="row m-0  p-0">
                                ...
                                <div className="col-md-4 text-start mt-3 pt-2">
