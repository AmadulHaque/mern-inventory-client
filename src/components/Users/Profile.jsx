...
const Profile = () => {
    ...
    let emailRef,NameRef,usernameRef,mobileRef,passwordRef,userImgRef,userImgView=useRef();
    ...
    const UpdateMyProfile = async () => {
        ...
        if (IsEmail(email)) {
            ...
            let result = await ProfileUpdateRequest(email, name, username, mobile, password, photo)
            if (result === true) {
                navigate("/")
            }
        }
                            ...
                            <div className="container-fluid">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-4 p-2">
                                        ...
                                        <input key={Date.now()} defaultValue={ProfileData['username']}  ref={(input)=>usernameRef=input} placeholder="Last Name" className="form-control animated fadeInUp" type="text"/>
                                    </div>
                                    <div className="col-4 p-2">
                                        <label>Mobile</label>
